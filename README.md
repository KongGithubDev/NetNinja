...
```bash
# Copy binaries
scp -i azure-sg.key netninja-proxy-linux <SSH_USER>@<SERVER_IP>:/tmp/proxy_linux
scp -i azure-sg.key netninja-keepalive-linux <SSH_USER>@<SERVER_IP>:/tmp/keepalive_server

# Deploy
ssh -i azure-sg.key <SSH_USER>@<SERVER_IP> "
...
2. Server: `<SERVER_IP>`, Port: `5988`
3. Open Safari → `https://<PROXY_HOST>`
